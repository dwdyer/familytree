...
urlpatterns = patterns(
    ...
    url(r'^(?P<person_id>\d+)/relatives/descendants/map$', views.descendants_map, name='descendants_map'),
    ...
    url(r'^(?P<person_id>\d+)/relatives/ancestors/map$', views.ancestors_map, name='ancestors_map'),
