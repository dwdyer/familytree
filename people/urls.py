...
urlpatterns = [
    ...
    url(r'^person/(?P<person_id>\d+)/ancestors/ringchart/(?P<depth>\d+)/$', views.ring_chart, name='ring_chart'),
    url(r'^person/(?P<person_id>\d+)/ancestors/ringchart/svg/(?P<depth>\d+)/$', views.ring_chart_svg, name='ring_chart_svg'),
